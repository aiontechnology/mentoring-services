...
public class RegistrationWorkflowConstants {
    ...
    // Process Names
    public static String STUDENT_REGISTRATION_PROCESS = "register-student";
    public static String STUDENT_INFORMATION_PROCESS = "request-student-info";
    ...
    public static String SCHOOL_EMAIL_TAG = "schoolEmailTag";
